...
public abstract class Double4x2JsonConverter : JsonConverter<double4x2>

{

    public delegate double4x2 ReadFunc(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options);

    public delegate void WriteFunc(Utf8JsonWriter writer, double4x2 value, JsonSerializerOptions options);

    public double4x2 ReadAsArray(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public void WriteAsArray(Utf8JsonWriter writer, double4x2 value, JsonSerializerOptions options)
    ...
    public double4x2 ReadAsObject(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public void WriteAsObject(Utf8JsonWriter writer, double4x2 value, JsonSerializerOptions options)
    ...
    public double4x2 ReadCompatible(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public Double4x2JsonConverter(JsonTokenType readerTokenType = JsonTokenType.None, JsonTokenType writerTokenType = JsonTokenType.None) : base()
