...
public abstract class Int2x2JsonConverter : JsonConverter<int2x2>

{

    public delegate int2x2 ReadFunc(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options);

    public delegate void WriteFunc(Utf8JsonWriter writer, int2x2 value, JsonSerializerOptions options);

    public int2x2 ReadAsArray(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public void WriteAsArray(Utf8JsonWriter writer, int2x2 value, JsonSerializerOptions options)
    ...
    public int2x2 ReadAsObject(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public void WriteAsObject(Utf8JsonWriter writer, int2x2 value, JsonSerializerOptions options)
    ...
    public int2x2 ReadCompatible(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public Int2x2JsonConverter(JsonTokenType readerTokenType = JsonTokenType.None, JsonTokenType writerTokenType = JsonTokenType.None) : base()
