...
{
    public delegate double4x4 ReadFunc(
    ...
    public double4x4 ReadCompatible(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    ) =>
