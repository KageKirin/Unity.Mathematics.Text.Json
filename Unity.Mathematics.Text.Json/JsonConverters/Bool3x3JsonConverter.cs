...
public abstract class Bool3x3JsonConverter : JsonConverter<bool3x3>

{

    public delegate bool3x3 ReadFunc(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options);

    public delegate void WriteFunc(Utf8JsonWriter writer, bool3x3 value, JsonSerializerOptions options);

    public bool3x3 ReadAsArray(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public void WriteAsArray(Utf8JsonWriter writer, bool3x3 value, JsonSerializerOptions options)
    ...
    public bool3x3 ReadAsObject(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public void WriteAsObject(Utf8JsonWriter writer, bool3x3 value, JsonSerializerOptions options)
    ...
    public bool3x3 ReadCompatible(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public Bool3x3JsonConverter(JsonTokenType readerTokenType = JsonTokenType.None, JsonTokenType writerTokenType = JsonTokenType.None) : base()
