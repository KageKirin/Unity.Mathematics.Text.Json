...
public abstract class Float4x4JsonConverter : JsonConverter<float4x4>

{

    public delegate float4x4 ReadFunc(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options);

    public delegate void WriteFunc(Utf8JsonWriter writer, float4x4 value, JsonSerializerOptions options);

    public float4x4 ReadAsArray(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public void WriteAsArray(Utf8JsonWriter writer, float4x4 value, JsonSerializerOptions options)
    ...
    public float4x4 ReadAsObject(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)

    {
        ...
        reader.Read();
        value.c3.w = (float)reader.GetDouble("m33");
    ...
    public void WriteAsObject(Utf8JsonWriter writer, float4x4 value, JsonSerializerOptions options)
    ...
    public float4x4 ReadCompatible(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public Float4x4JsonConverter(JsonTokenType readerTokenType = JsonTokenType.None, JsonTokenType writerTokenType = JsonTokenType.None) : base()
