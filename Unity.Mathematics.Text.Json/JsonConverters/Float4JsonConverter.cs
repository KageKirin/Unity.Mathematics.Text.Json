...
public abstract class Float4JsonConverter : JsonConverter<float4>

{

    public delegate float4 ReadFunc(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options);

    public delegate void WriteFunc(Utf8JsonWriter writer, float4 value, JsonSerializerOptions options);

    public float4 ReadAsArray(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)

    {
        ...
        reader.Read();
        value.w = (float)reader.GetDouble();
    ...
    public void WriteAsArray(Utf8JsonWriter writer, float4 value, JsonSerializerOptions options)
    ...
    public float4 ReadAsObject(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public void WriteAsObject(Utf8JsonWriter writer, float4 value, JsonSerializerOptions options)
    ...
    public float4 ReadCompatible(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public Float4JsonConverter(JsonTokenType readerTokenType = JsonTokenType.None, JsonTokenType writerTokenType = JsonTokenType.None) : base()
