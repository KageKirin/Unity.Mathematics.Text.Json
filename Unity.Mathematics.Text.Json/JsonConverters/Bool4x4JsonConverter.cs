...
public abstract class Bool4x4JsonConverter : JsonConverter<bool4x4>

{

    public delegate bool4x4 ReadFunc(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options);

    public delegate void WriteFunc(Utf8JsonWriter writer, bool4x4 value, JsonSerializerOptions options);

    public bool4x4 ReadAsArray(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public void WriteAsArray(Utf8JsonWriter writer, bool4x4 value, JsonSerializerOptions options)
    ...
    public bool4x4 ReadAsObject(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)

    {
        ...
        reader.Read();
        value.c3.w = reader.GetBoolean("m33");
    ...
    public void WriteAsObject(Utf8JsonWriter writer, bool4x4 value, JsonSerializerOptions options)

    {
        ...
        writer.WriteBoolean("m33", value.c3.w);
        
        writer.WriteEndObject();

    }

    public bool4x4 ReadCompatible(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    ...
    public Bool4x4JsonConverter(JsonTokenType readerTokenType = JsonTokenType.None, JsonTokenType writerTokenType = JsonTokenType.None) : base()
